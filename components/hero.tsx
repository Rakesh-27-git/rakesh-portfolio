      ...
      <div className="flex justify-center md:justify-start">
        <div className="relative h-40 w-40 overflow-hidden rounded-full ring-1 ring-white/10 shadow-[0_8px_40px_-16px_rgba(0,0,0,0.6)]">
          <Image
            ...
            alt="Rakesh Choudhary profile photo"
            fill
      ...
      <div className="space-y-4 text-center md:text-left">
        <div className="space-y-1">
          ...
          <p className="max-w-2xl text-[color:var(--muted)]">
            Full Stack Developer who turns ideas into fast, scalable web apps.
            React on the front, Node on the back — and a little AI magic in the
            middle.
          </p>
        </div>
        <div className="flex flex-col gap-3 sm:flex-row sm:justify-start sm:gap-4">
          ...
          >
            <a
              href="https://drive.google.com/file/d/14EIbbHp9EdYZlh-Be97yfBRIyT09PvV6/view"
              target="_blank"
          ...
          >
            <Link
              target="_blank"
              href="https://github.com/Rakesh-27-git"
