...
const socials: Social[] = [
  { name: "GitHub", href: "https://github.com/Rakesh-27-git", icon: Github },
  {
    name: "LinkedIn",
    href: "https://www.linkedin.com/in/rakesh-choudhary-540256261",
    icon: Linkedin,
  },
  { name: "Email", href: "mailto:rakeshchoudhary8779@gmail.com", icon: Mail },
];
...
export default function SocialDock() {
  ...
  const handleEmailClick = async (e: React.MouseEvent) => {
    e.preventDefault();
    try {
      await navigator.clipboard.writeText("rakeshchoudhary8779@gmail.com");
      toast({
        title: "Email copied!",
      ...
      textArea.value = "rakeshchoudhary8779@gmail.com";
      ...
      try {
        ...
        toast({
          title: "Copy failed",
          description:
            "Unable to copy email address. Please copy it manually: rakeshchoudhary8779@gmail.com",
          variant: "destructive",
        });
      }
              ...
              <Tooltip key={link.name}>
                <TooltipTrigger asChild>
                  <a
                    ...
                    onClick={
                      link.name === "Email" ? handleEmailClick : undefined
                    }
                  >
                    <div
